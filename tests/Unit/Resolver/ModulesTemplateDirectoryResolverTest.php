...
final class ModulesTemplateDirectoryResolverTest extends TestCase
{
    ...
    {
        $this->activeModulesDataProvider->method('getModulePaths')->willReturn([]);
    ...
    {
        $this->activeModulesDataProvider->method('getModulePaths')->willReturn([
            'module-without-templates' => '/path/to/module-without-templates',
            'module-with-templates' => '/path/to/module-with-templates',
        ]);
    ...
    {
        $this->activeModulesDataProvider->method('getModulePaths')->willReturn([
            'first-module' => '/modules/first',
            'second-module' => '/modules/second',
            'third-module' => '/modules/third',
        ]);
